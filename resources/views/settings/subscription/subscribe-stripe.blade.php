        ...
        <div class="panel panel-default" v-show="selectedPlan">
            ...
            <div class="panel-body">
                ...
                <!-- Cardholder's Name -->
                    ...
                    <!-- Security Code -->
                    <div class="form-group">
                        <label for="number" class="col-md-4 control-label">@lang('Security Code')</label>
                    ...
                    <div class="form-group" v-if=" ! spark.collectsBillingAddress">
                        <label for="number" class="col-md-4 control-label">@lang('ZIP / Postal Code')</label>
                    ...
                    <div class="form-group" :class="{'has-error': form.errors.has('coupon')}">
                        <label class="col-md-4 control-label">@lang('Coupon')</label>
