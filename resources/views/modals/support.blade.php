        ...
        <div class="modal-content">
            <div class="modal-body p-b-none">
                <form class="form-horizontal p-b-none m-b-none" role="form">
                    ...
                    <div class="form-group" :class="{'has-error': supportForm.errors.has('from')}">
                        <div class="col-md-12">
                            <input id="support-from" type="text" class="form-control" v-model="supportForm.from" placeholder="@lang('Your Email Address')">
                    ...
                    <div class="form-group" :class="{'has-error': supportForm.errors.has('subject')}">
                        <div class="col-md-12">
                            <input id="support-subject" type="text" class="form-control" v-model="supportForm.subject" placeholder="@lang('Subject')">
                    ...
                    <div class="form-group m-b-none" :class="{'has-error': supportForm.errors.has('message')}">
                        <div class="col-md-12">
                            <textarea class="form-control" rows="7" v-model="supportForm.message" placeholder="@lang('Message')"></textarea>
            ...
            <div class="modal-footer border-none">
                <button type="button" class="btn btn-primary" @click.prevent="sendSupportRequest" :disabled="supportForm.busy">
                    <i class="fa fa-btn fa-paper-plane"></i>@lang('Send')
                </button>
            </div>
        </div>
    </div>
