        ...
        <div class="spark-screen container">
            <div class="row">
              ...
              18c2.7737 0 5.2177-1.4116 6.6528-3.5556C14.6268 13.517 12.3738 13 10 13s-4.627.517-6.6528 1.4444z "></path>
                            ...
                            @if (Spark::usesTeams())
                                <li class="nav-item ">
                                    <a class="nav-link" href="#{{str_plural(Spark::teamString())}}" aria-controls="teams" role="tab" data-toggle="tab">
              ...
              1 .5 1 1v1zm1 18c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2zm10 0c-1 0-2-1-2-2s1-2 2-2 2 1 2 2-1 2-2 2z " />
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        ...
                        <!-- Teams -->
                        @if (Spark::usesTeams())
                            <div role="tabcard" class="tab-pane" id="{{str_plural(Spark::teamString())}}">
