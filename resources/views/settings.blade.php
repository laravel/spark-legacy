                            ...
                            <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                ...
                                <li role="presentation">
                                    <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-edit"></i>{{ __('spark::app.auth.profile') }}
                                    </a>
                                </li>
                                ...
                                <li role="presentation">
                                    <a href="#security" aria-controls="security" role="tab" data-toggle="tab">
                                        <i class="fa fa-fw fa-btn fa-lock"></i>{{ __('spark::app.auth.security') }}
                                    </a>
                                </li>
                                ...
                                @if (Spark::usesApi())
                                    <li role="presentation">
                                        <a href="#api" aria-controls="api" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-cubes"></i>{{ __('spark::app.auth.api') }}
                                        </a>
                                    </li>
                                @endif
                            </ul>
                                ...
                                <ul class="nav spark-settings-stacked-tabs" role="tablist">
                                    @if (Spark::hasPaidPlans())
                                        ...
                                        <li role="presentation">
                                            <a href="#subscription" aria-controls="subscription" role="tab" data-toggle="tab">
                                                <i class="fa fa-fw fa-btn fa-shopping-bag"></i>{{ __('spark::app.billing.subscription') }}
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    <li role="presentation">
                                        <a href="#payment-method" aria-controls="payment-method" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-credit-card"></i>{{ __('spark::app.billing.payment-method') }}
                                        </a>
                                    </li>
                                    ...
                                    <li role="presentation">
                                        <a href="#invoices" aria-controls="invoices" role="tab" data-toggle="tab">
                                            <i class="fa fa-fw fa-btn fa-history"></i>{{ __('spark::app.billing.invoices') }}
                                        </a>
                                    </li>
                                </ul>
                            </div>
