...
<div class="form-group" :class="{'has-error': registerForm.errors.has('state')}">
    ...
    <!-- State -->
    <div class="col-sm-3">
        <input type="text" class="form-control" placeholder="@lang('State')" v-model.lazy="registerForm.state">
    ...
    <!-- Zip Code -->
    <div class="col-sm-3">
        <input type="text" class="form-control" placeholder="@lang('Postal Code')" v-model.lazy="registerForm.zip">
...
<div class="form-group" :class="{'has-error': registerForm.errors.has('vat_id')}" v-if="countryCollectsVat">
    <label class="col-md-4 control-label">@lang('VAT ID')</label>
